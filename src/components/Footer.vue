      ...
      <div class="container pt-20">
         <div class="flex flex-col md:flex-row justify-center gap-8 md:gap-32 mb-20">
            ...
            <div class="flex flex-col gap-2">
               <router-link @click="reloadPage" to="/about" class="text-lg text-center md:text-start text-white hover:text-primary/70 transition duration-200">Home</router-link>
