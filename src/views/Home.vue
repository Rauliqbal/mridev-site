     ...
     <div class="container pt-20">
       <div class="flex flex-col md:flex-row justify-center gap-8 md:gap-32 mb-20">
         ...
         <div class="flex flex-col gap-2">
           <router-link class="text-lg text-center md:text-start text-white hover:text-slate-500 transition duration-200" to="/">About me</router-link>
           <router-link class="text-lg text-center md:text-start text-white hover:text-slate-500 transition duration-200" to="/">Resume</router-link>
           <router-link class="text-lg text-center md:text-start text-white hover:text-slate-500 transition duration-200" to="/">Skills</router-link>
           <router-link class="text-lg text-center md:text-start text-white hover:text-slate-500 transition duration-200" to="/">Projects</router-link>
         </div>
       </div>
